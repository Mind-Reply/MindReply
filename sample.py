...
def main() -> None:
    ...
    endpoint = "https://mindreply.services.ai.azure.com/"
    ...
    file_url = "https://contentunderstanding.ai.azure.com/assets/prebuilt/credit-card-horizontal.png"

    # ANALYZER_ID - the ID of the analyzer to use.
    analyzer_id = "prebuilt-creditCard"
