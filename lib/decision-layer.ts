...
const localized = {
  ...
  bg: {
    ...
    risk: { high: "Напрежението може да доведе до ход, който заслужава преглед преди изпращане.", medium: "Ситуацията е чувствителна и изисква по-бавен език и по-ясни граници.", low: "Не е открит блокиращ риск; може да се действа внимателно." },
    memory: "Бележката за памет се задържа до одобрение; суровият текст остава извън разписката.",
    synthesis: { escalate: "Това още не е проблем с формулировката; това е проблем с въздържането.", reply: "Видимият въпрос е езикът, но реалното напрежение е доверие, момент и авторитет.", schedule: "Това не иска бърз отговор, а ясно място във времето.", resolve: "Това е достатъчно ясно, за да бъде назовано, записано и освободено от вниманието." },
    mind: { escalate: ["Става дума да не позволите на напрежението да вземе гласа ви.", "Спешността търси контрол; прегледът е по-чист контрол.", "Задръжте отговора и се върнете с по-ясен сигнал."], reply: ["Става дума да държите топлина и авторитет заедно.", "Пазите връзката и позицията си.", "Отговорете спокойно, оставете границата видима и назовете следващата стъпка."], schedule: ["Това има нужда от ритъм, не от още премисляне.", "Вниманието ви се опитва да не изпусне нищо.", "Дайте му един момент за проследяване и го оставете."], resolve: ["Това иска затваряне, не разширяване.", "Достатъчната сигурност вече е налице.", "Назовете решението, запазете разписката и го оставете."] },
    actions: { reply: ["Изпрати ясен и спокоен отговор", "Благодаря за директността. Разбирам притеснението. Чистата следваща стъпка е да запазим точката на решение ясна, да защитим отношенията и да уточним момента, без да добавяме още напрежение."], schedule: ["Постави тихо проследяване", "MindReply проследяване"], escalate: ["Задръж за преглед", ""], resolve: ["Маркирай като решено", ""] },
  },
