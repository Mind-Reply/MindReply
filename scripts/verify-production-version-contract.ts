...
const checks: Array<[label: string, file: string, expected: string]> = [
  ...
  ["alias ready workflow", "aliasReadyWorkflow", "https://mindreply-kbqlfz2h8-angellllkr-engs-projects.vercel.app"],
  ["alias ready workflow", "aliasReadyWorkflow", "85a86a6f94bca2f8f1d5ff69894ba4a85cb1ecd7"],
  ["alias ready workflow", "aliasReadyWorkflow", "dpl_ALssxKSrgiWh3rJgNzmmyv5WZiPE"],
