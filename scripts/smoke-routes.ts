...
const routes = [
  ...
  { path: "/bookings" },
  { path: "/tools" },
  { path: "/tools/ops-overload-analyzer" },
  { path: "/tools/text-refiner" },
  { path: "/tools/email-polisher" },
  { path: "/tools/prospect-reply-analyzer" },
  { path: "/agent" },
  { path: "/login" },
  { path: "/sign-in" },
  { path: "/sign-up" },
  ...
  { path: "/api/checkout/rescue" },
  { path: "/api/agents/active", expectedStatuses: [401] },
  { path: "/api/agents/accelerate", expectedStatuses: [401] },
  { path: "/api/agents/roster", expectedStatuses: [401] },
  { path: "/api/agents/learning", expectedStatuses: [401] },
  ...
  { path: "/api/config/requirements", expectedStatuses: [401] },
  { path: "/api/entitlements" },
  { path: "/api/intelligence/analyze" },
  { path: "/api/ops/status", expectedStatuses: [401] },
