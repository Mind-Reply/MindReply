...
> = {
  en: {
    eyebrow: "Executive Nervous System",
    demand: "High demand, scarce trusted operators: leaders need one clear move before another screen.",
    h1: "MindReply turns pressure into the next action.",
    lead:
      "Decision Infrastructure for executives, founders, and expert-led firms. It filters signal, protects judgment, and keeps momentum discreet.",
    primary: "Run decision surface",
    details: "Full package info",
    proof: ["One synthesis", "One recommended action", "Private memory update"],
    packTitle: "Full Pack",
    packageIntro:
      "Website Completion Package: premium positioning, trust proof, privacy language, phone-first layout, assisted close, and owner reports.",
    packageItems: [
      "Homepage authority layer with precise vocabulary.",
      "Search-ready metadata and clear buyer proof.",
      "Phone layout with no visual gaps.",
      "Calm close path for serious buyers.",
      "Owner report after every meaningful change.",
    ],
    intakeKicker: "Intake Layer",
    intakeTitle: "One synthesis. One action.",
    ...
    visionBody: "MindReply replaces the space between tools: less hesitation, safer response, clearer follow-through.",
    footerLine: "Calm decision infrastructure for modern executive work.",
    footer: ["Intake", "Action", "Memory", "Owner proof"],
    language: "Language",
  ...
  ar: {
    eyebrow: "Executive Nervous System",
    demand: "Strong demand, few trusted operators: leaders need one clear move.",
    h1: "MindReply turns pressure into the next action.",
    lead: "Private decision infrastructure for leaders. It reads the signal, lowers risk, and prepares the right move.",
    primary: "Open decision",
    details: "Full package info",
    proof: ["One synthesis", "One recommended action", "Private memory update"],
    packTitle: "Full Pack",
    packageIntro: "Website Completion Package: premium positioning, trust proof, privacy language, phone-first layout, and owner reports.",
    packageItems: ["Homepage authority.", "Search-ready metadata.", "Phone layout with no gaps.", "Calm close path.", "Owner report after each change."],
    intakeKicker: "Intake Layer",
    intakeTitle: "One synthesis. One action.",
    privateLabel: "private by default",
    inputLabel: "Input",
    ...
    handled: "This has been handled. ",
    visionTitle: "The vision",
    visionBody: "MindReply reduces hesitation, protects the response, and keeps follow-through clear.",
    footerLine: "Calm decision infrastructure for modern executive work.",
    footer: ["Intake", "Action", "Memory", "Owner proof"],
    language: "Language",
    country: "Detected country",
        ...
        <div className="grid gap-4 pb-6 lg:pb-0">
          {packOpen ? (
            <section className="rounded-lg border border-[#3d443e] bg-[#161d19] p-5 shadow-2xl shadow-black/30 md:p-6">
              <p className="text-xs uppercase tracking-[0.18em] text-[#c9a95f]">Revenue surface</p>
